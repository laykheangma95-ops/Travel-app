...
const dicts = {
  en: {
    ...
    // Time-of-day greeting (rendered client-side only — see HeroGreeting)
    'hero.greet.morning': 'Good morning',
    'hero.greet.afternoon': 'Good afternoon',
    'hero.greet.evening': 'Good evening',
    'hero.headline': 'Where are you traveling next?',
    'hero.subheadline': 'Plan smarter. Stay connected. Travel with confidence.',
    // Homepage travel feed
    'feed.trending.eyebrow': 'Trending now',
    'feed.trending.title': 'Where Cambodians are flying',
    'feed.trending.desc': 'Live local time, typical daily budget and what a data plan costs.',
    'feed.tips.eyebrow': 'Before you go',
    'feed.tips.title': 'Things worth knowing first',
    'feed.tips.desc': 'Short, practical, and written for a Cambodian passport.',
    'feed.alerts.eyebrow': 'Travel alerts',
    'feed.alerts.title': 'What to watch for',
    'feed.alerts.empty': 'No active alerts for these destinations right now.',
    'feed.why.eyebrow': 'Why travelers stay',
    'feed.why.title': 'We start helping before you buy',
    'feed.readMore': 'Read the guide',
    // Features
  ...
  km: {
    ...
    'hero.greet.morning': 'អរុណសួស្តី',
    'hero.greet.afternoon': 'ទិវាសួស្តី',
    'hero.greet.evening': 'សាយណ្ហសួស្តី',
    'hero.headline': 'តើអ្នកនឹងធ្វើដំណើរទៅណាបន្ទាប់?',
    'hero.subheadline': 'រៀបចំផែនការឆ្លាតវៃ។ តភ្ជាប់ជានិច្ច។ ធ្វើដំណើរដោយទំនុកចិត្ត។',
    'feed.trending.eyebrow': 'កំពុងពេញនិយម',
    'feed.trending.title': 'កន្លែងដែលជនជាតិខ្មែរកំពុងហោះទៅ',
    'feed.trending.desc': 'ម៉ោងក្នុងស្រុក ថវិកាប្រចាំថ្ងៃ និងតម្លៃគម្រោងអ៊ីនធឺណិត។',
    'feed.tips.eyebrow': 'មុនពេលចេញដំណើរ',
    'feed.tips.title': 'រឿងដែលគួរដឹងជាមុន',
    'feed.tips.desc': 'ខ្លី ជាក់ស្តែង និងសរសេរសម្រាប់លិខិតឆ្លងដែនខ្មែរ។',
    'feed.alerts.eyebrow': 'ការជូនដំណឹងធ្វើដំណើរ',
    'feed.alerts.title': 'អ្វីដែលត្រូវប្រុងប្រយ័ត្ន',
    'feed.alerts.empty': 'មិនមានការជូនដំណឹងសម្រាប់គោលដៅទាំងនេះទេ។',
    'feed.why.eyebrow': 'ហេតុអ្វីអ្នកដំណើរនៅជាមួយយើង',
    'feed.why.title': 'យើងជួយអ្នកមុនពេលអ្នកទិញ',
    'feed.readMore': 'អានការណែនាំ',
    // Features
