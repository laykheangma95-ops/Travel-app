...
const dicts = {
  en: {
    ...
    // ── The purchase funnel ──
    // Store, cart and checkout carried no translated strings at all: no
    // useLang, no keys, English hardcoded throughout. Every screen where a
    // Cambodian customer spends money was one of them, in a product whose
    // customer interface is meant to be Khmer-first.
    'shop.eyebrow': 'Global data',
    'shop.title': 'eSIM Store',
    'shop.finderTitle': 'Not sure how much data you need?',
    'shop.finderBody': "Answer three quick questions and we'll pick a plan for you.",
    'shop.tab.top': 'Top destinations',
    'shop.tab.countries': 'Countries',
    'shop.tab.regions': 'Regions',
    'shop.tab.global': 'Global',
    'shop.searchPlaceholder': 'Search any country or city…',
    'shop.searchLabel': 'Search destination',
    'shop.regionFilter': 'Filter by region',
    'shop.browseBy': 'Browse by',
    'shop.guidesLink': 'Looking for destination guides? Explore them here',
    'shop.top.title': 'What Cambodians buy most',
    'shop.top.body': 'The destinations that move first every month.',
    'shop.countries.body': "Including the ones that have no plan of their own. Italy, Portugal and Norway are all on the Europe eSIM; the card tells you which plan you're buying.",
    'shop.regions.title': 'Multi-country plans',
    'shop.regions.body': 'One eSIM across a whole trip. For a Bangkok–Singapore–KL run this beats buying three.',
    'shop.roaming.title': 'Country plans that roam',
    'shop.roaming.body': 'Filed under one country by our supplier, but valid across many. The France eSIM is the clearest example — it works in 32 countries.',
    'shop.global.title': 'Widest coverage we sell',
    'shop.global.body': 'Every plan that crosses a border three times or more, widest first.',
    'shop.noResults.title': 'No destinations found',
    'shop.noResults.cta': 'Clear search',
    'shop.region.All': 'All',
    // Cart
    'plan.buyNow': 'Buy now',
    'plan.addToCart': 'Add to cart',
    'plan.added': 'Added to cart',
    'cart.title': 'Your Cart',
    'cart.empty.title': 'Your cart is empty',
    'cart.empty.body': 'Browse our eSIM store and add a plan for your next destination.',
    ...
    'cart.days': 'days',
    'cart.perDay': 'GB/day',
    'cart.totalData': 'GB total',
    'cart.code.label': 'Discount code',
    'cart.code.apply': 'Apply',
    'cart.code.invalid': 'This code is not valid or has expired.',
    'cart.code.referral': 'Referral code applied automatically.',
    'cart.checkout': 'Proceed to Checkout',
    // Checkout
    'checkout.eyebrow': 'Almost there',
    'checkout.title': 'Checkout',
    'checkout.empty.title': 'Nothing to check out',
    'checkout.empty.body': 'Add an eSIM plan to your cart first.',
    'checkout.details': 'Your details',
    'checkout.fullName': 'Full Name',
    'checkout.email': 'Email Address',
    'checkout.device': 'Device Type',
    'checkout.device.notSure': 'Not sure',
    ...
    'checkout.pay.cards': 'International Cards',
    'checkout.pay.cardsHint': 'Visa · Mastercard · Amex — via Stripe',
    'checkout.pay.abaHint': 'KHQR · ABA Mobile · local cards',
    'checkout.payCard': 'Pay with Card',
    'checkout.payAba': 'Pay with ABA / KHQR',
    'checkout.processing': 'Processing…',
    'checkout.reassurance': 'Secure payment · QR delivered within 15 minutes',
    ...
    'checkout.failed': 'Payment could not be started. Please try again.',
    ...
    // Saving a place onto a trip
    'v3.save.action': 'Save to my trip',
    'v3.save.saving': 'Saving…',
    'v3.save.saved': 'Saved to {trip}',
    'v3.save.already': 'Already on {trip}',
    'v3.save.created': 'Started {trip} for you',
    'v3.save.view': 'Open trip',
    'v3.save.signIn': 'Sign in to save',
    'v3.save.chooseTitle': 'Which trip?',
    'v3.save.chooseHint': 'You have more than one trip here.',
    ...
    'saved.working': 'Saving…',
    'saved.signIn': 'Sign in to save',
    'saved.error': 'Could not do that. Try again.',
    'saved.title': 'Saved places',
    'saved.subtitle': 'Places you have kept. They stay here whether or not they are on a trip.',
    'saved.empty': 'Nothing saved yet.',
    'saved.emptyHint': 'Places you keep will appear here, ready to put on a trip later.',
    'saved.all': 'All',
    'saved.count': '{n} saved',
    'saved.loadError': 'Could not load your saved places. Try again.',
    'saved.loadMore': 'Load more',
    'saved.loadingMore': 'Loading…',
    'place.signInTitle': 'Sign in to view this place',
    'place.signInSubtitle': 'Places are shown to signed-in travelers.',
    'place.notFound': "We couldn't find that place",
    'place.notFoundHint': 'It may not exist, or it is not visible to you yet.',
    'place.loadError': 'Could not load this place. Try again.',
    'place.backToSaved': 'Back to saved places',
    'place.saveCount.zero': 'Not yet saved by any traveler',
    ...
    'addToTrip.action': 'Add to trip',
    'addToTrip.adding': 'Adding…',
    'addToTrip.added': 'Added to {trip}',
    'addToTrip.already': 'Already on {trip}',
    'addToTrip.created': 'Started {trip} for you',
    'addToTrip.view': 'Open itinerary',
    'addToTrip.signIn': 'Sign in to add to a trip',
    'addToTrip.chooseTitle': 'Which trip?',
    'addToTrip.chooseHint': 'You have more than one trip here.',
    'addToTrip.notFound': 'We could not find that place.',
    'addToTrip.error': 'Could not add that to a trip. Try again.',
    'intake.title': 'Save from social',
    'intake.subtitle': 'Paste a TikTok, Instagram, YouTube, Xiaohongshu or travel link.',
    'intake.placeholder': 'Paste a link',
    'intake.action': 'Import',
    'intake.working': 'Checking…',
    'intake.received': "We've got your link",
    'intake.receivedHint': 'We have saved it to work on. We have not read it yet — nothing has been added to a trip.',
    'intake.already': 'You had already sent us this one. Nothing was duplicated.',
    'intake.another': 'Send another',
    'intake.signIn': 'Sign in',
    'intake.signInHint': 'Saving a link needs an account, so it is there on every device.',
    'intake.error.invalid': 'That does not look like a link. Check it and try again.',
    'intake.error.unsupported': 'We cannot take that link.',
    'intake.error.rateLimited': 'Too many links at once. Wait a moment, then try again.',
    'intake.error.unavailable': 'Imports are unavailable right now. Try again soon.',
    'intake.error.server': 'Something went wrong on our side. Try again.',
    'intake.processing': 'Reading your link…',
    'intake.processingHint': 'Places and plans may be read wrongly, or not at all.',
    'intake.pollTimeout': "This is taking longer than usual. It's still working — check back in a bit.",
  ...
  km: {
    ...
    'shop.eyebrow': 'ទិន្នន័យទូទាំងពិភពលោក',
    'shop.title': 'ហាង eSIM',
    'shop.finderTitle': 'មិនប្រាកដថាត្រូវការទិន្នន័យប៉ុន្មានទេ?',
    'shop.finderBody': 'ឆ្លើយសំណួរបីខ្លីៗ ហើយយើងនឹងជ្រើសរើសគម្រោងសម្រាប់អ្នក។',
    'shop.tab.top': 'គោលដៅពេញនិយម',
    'shop.tab.countries': 'ប្រទេស',
    'shop.tab.regions': 'តំបន់',
    'shop.tab.global': 'ទូទាំងពិភពលោក',
    'shop.searchPlaceholder': 'ស្វែងរកប្រទេស ឬទីក្រុងណាមួយ…',
    'shop.searchLabel': 'ស្វែងរកគោលដៅ',
    'shop.regionFilter': 'ត្រងតាមតំបន់',
    'shop.browseBy': 'រកមើលតាម',
    'shop.guidesLink': 'ស្វែងរកមគ្គុទ្ទេសក៍គោលដៅមែនទេ? មើលនៅទីនេះ',
    'shop.top.title': 'អ្វីដែលខ្មែរទិញច្រើនជាងគេ',
    'shop.top.body': 'គោលដៅដែលលក់ដាច់មុនគេរាល់ខែ។',
    'shop.countries.body': 'រួមទាំងប្រទេសដែលគ្មានគម្រោងផ្ទាល់ខ្លួន។ អ៊ីតាលី ព័រទុយហ្គាល់ និងន័រវេស សុទ្ធតែស្ថិតក្នុង eSIM អឺរ៉ុប។ កាតនីមួយៗប្រាប់អ្នកថាកំពុងទិញគម្រោងណា។',
    'shop.regions.title': 'គម្រោងច្រើនប្រទេស',
    'shop.regions.body': 'eSIM មួយសម្រាប់ដំណើរទាំងមូល។ សម្រាប់ផ្លូវ បាងកក–សិង្ហបុរី–គូឡាឡាំពួរ វាសមរម្យជាងទិញបី។',
    'shop.roaming.title': 'គម្រោងប្រទេសដែលប្រើបានច្រើនកន្លែង',
    'shop.roaming.body': 'ចុះឈ្មោះក្រោមប្រទេសមួយដោយអ្នកផ្គត់ផ្គង់ ប៉ុន្តែប្រើបានច្រើនប្រទេស។ eSIM បារាំងជាឧទាហរណ៍ច្បាស់បំផុត — វាដំណើរការក្នុង ៣២ ប្រទេស។',
    'shop.global.title': 'ការគ្របដណ្តប់ធំបំផុតដែលយើងលក់',
    'shop.global.body': 'គ្រប់គម្រោងដែលឆ្លងព្រំដែនបីដងឡើងទៅ ធំបំផុតមុនគេ។',
    'shop.noResults.title': 'រកមិនឃើញគោលដៅ',
    'shop.noResults.cta': 'សម្អាតការស្វែងរក',
    'shop.region.All': 'ទាំងអស់',
    'plan.buyNow': 'ទិញឥឡូវនេះ',
    'plan.addToCart': 'បន្ថែមទៅកន្ត្រក',
    'plan.added': 'បានបន្ថែមហើយ',
    'cart.title': 'កន្ត្រករបស់អ្នក',
    'cart.empty.title': 'កន្ត្រកទទេ',
    'cart.empty.body': 'រកមើលហាង eSIM ហើយបន្ថែមគម្រោងសម្រាប់គោលដៅបន្ទាប់របស់អ្នក។',
    ...
    'cart.days': 'ថ្ងៃ',
    'cart.perDay': 'GB/ថ្ងៃ',
    'cart.totalData': 'GB សរុប',
    'cart.code.label': 'កូដបញ្ចុះតម្លៃ',
    'cart.code.apply': 'ប្រើ',
    'cart.code.invalid': 'កូដនេះមិនត្រឹមត្រូវ ឬផុតកំណត់ហើយ។',
    'cart.code.referral': 'កូដណែនាំត្រូវបានប្រើដោយស្វ័យប្រវត្តិ។',
    ...
    'checkout.empty.body': 'សូមបន្ថែមគម្រោង eSIM ទៅកន្ត្រកជាមុនសិន។',
    'checkout.details': 'ព័ត៌មានរបស់អ្នក',
    'checkout.fullName': 'ឈ្មោះពេញ',
    'checkout.email': 'អាសយដ្ឋានអ៊ីមែល',
    'checkout.device': 'ប្រភេទឧបករណ៍',
    'checkout.device.notSure': 'មិនប្រាកដ',
    'checkout.notes': 'កំណត់ចំណាំពិសេស (ជាជម្រើស)',
    'checkout.notesPlaceholder': 'មានអ្វីដែលយើងគួរដឹងទេ?',
    'checkout.delivery': 'ការផ្ញើកូដ QR',
    'checkout.summary': 'សេចក្តីសង្ខេបការបញ្ជាទិញ',
    'checkout.total': 'សរុប',
    'checkout.payment': 'វិធីទូទាត់',
    'checkout.pay.cards': 'កាតអន្តរជាតិ',
    'checkout.pay.cardsHint': 'Visa · Mastercard · Amex — តាម Stripe',
    'checkout.pay.abaHint': 'KHQR · ABA Mobile · កាតក្នុងស្រុក',
    'checkout.payCard': 'ទូទាត់ដោយកាត',
    'checkout.payAba': 'ទូទាត់ដោយ ABA / KHQR',
    'checkout.processing': 'កំពុងដំណើរការ…',
    'checkout.reassurance': 'ការទូទាត់សុវត្ថិភាព · កូដ QR មកដល់ក្នុង ១៥ នាទី',
    'checkout.phoneOptional': 'លេខទូរស័ព្ទ (ជាជម្រើស)',
    'checkout.phone': 'លេខទូរស័ព្ទ',
    'checkout.phoneHintEmail': 'ប្រើតែពេលយើងត្រូវទាក់ទងអ្នកអំពីការបញ្ជាទិញនេះ។',
    'checkout.phoneHintTelegram': 'ប្រើដើម្បីបញ្ជាក់ថា Telegram នេះជារបស់អ្នក។',
    'checkout.failed': 'មិនអាចចាប់ផ្តើមការទូទាត់បានទេ។ សូមព្យាយាមម្ដងទៀត។',
    ...
    // Saving a place onto a trip
    'v3.save.action': 'រក្សាទុកទៅដំណើររបស់ខ្ញុំ',
    'v3.save.saving': 'កំពុងរក្សាទុក…',
    'v3.save.saved': 'បានរក្សាទុកក្នុង {trip}',
    'v3.save.already': 'មាននៅក្នុង {trip} រួចហើយ',
    'v3.save.created': 'បានបង្កើត {trip} ជូនអ្នក',
    'v3.save.view': 'បើកដំណើរ',
    'v3.save.signIn': 'ចូលគណនី ដើម្បីរក្សាទុក',
    'v3.save.chooseTitle': 'ដំណើរមួយណា?',
    'v3.save.chooseHint': 'អ្នកមានដំណើរច្រើនជាងមួយនៅទីនេះ។',
    ...
    'saved.action': 'រក្សាទុក',
    'saved.kept': 'បានរក្សាទុក',
    'saved.remove': 'ដកចេញពីការរក្សាទុក',
    'saved.working': 'កំពុងរក្សាទុក…',
    'saved.signIn': 'ចូលគណនីដើម្បីរក្សាទុក',
    'saved.error': 'មិនអាចធ្វើបានទេ។ សូមព្យាយាមម្តងទៀត។',
    'saved.title': 'កន្លែងដែលបានរក្សាទុក',
    'saved.subtitle': 'កន្លែងដែលអ្នកបានរក្សាទុក។ វានៅទីនេះ ទោះជាមាននៅក្នុងដំណើរកម្សាន្តឬអត់។',
    'saved.empty': 'មិនទាន់មានអ្វីរក្សាទុកទេ។',
    'saved.emptyHint': 'កន្លែងដែលអ្នករក្សាទុកនឹងបង្ហាញនៅទីនេះ ដើម្បីដាក់ចូលដំណើរកម្សាន្តពេលក្រោយ។',
    'saved.all': 'ទាំងអស់',
    'saved.count': 'បានរក្សាទុក {n}',
    'saved.loadError': 'មិនអាចទាញយកបានទេ។ សូមព្យាយាមម្តងទៀត។',
    'saved.loadMore': 'ទាញយកបន្ថែម',
    'saved.loadingMore': 'កំពុងទាញយក…',
    'place.signInTitle': 'ចូលគណនីដើម្បីមើលកន្លែងនេះ',
    'place.signInSubtitle': 'កន្លែងនានាបង្ហាញសម្រាប់អ្នកដំណើរដែលបានចូលគណនីតែប៉ុណ្ណោះ។',
    'place.notFound': 'រកមិនឃើញកន្លែងនោះទេ',
    'place.notFoundHint': 'វាប្រហែលជាមិនមាន ឬអ្នកមិនទាន់អាចមើលឃើញនៅឡើយទេ។',
    'place.loadError': 'មិនអាចទាញយកកន្លែងនេះបានទេ។ សូមព្យាយាមម្តងទៀត។',
    'place.backToSaved': 'ត្រឡប់ទៅកន្លែងដែលបានរក្សាទុក',
    'place.saveCount.zero': 'មិនទាន់មានអ្នកដំណើររក្សាទុកទេ',
    ...
    'addToTrip.already': 'មាននៅក្នុង {trip} រួចហើយ',
    'addToTrip.created': 'បានបង្កើត {trip} ជូនអ្នក',
    'addToTrip.view': 'បើកកម្មវិធីដំណើរ',
    'addToTrip.signIn': 'ចូលគណនីដើម្បីបន្ថែមទៅដំណើរកម្សាន្ត',
    'addToTrip.chooseTitle': 'ដំណើរមួយណា?',
    'addToTrip.chooseHint': 'អ្នកមានដំណើរច្រើនជាងមួយនៅទីនេះ។',
    'addToTrip.notFound': 'រកមិនឃើញកន្លែងនោះទេ។',
    'addToTrip.error': 'មិនអាចបន្ថែមទៅដំណើរបានទេ។ សូមព្យាយាមម្តងទៀត។',
    'intake.title': 'រក្សាទុកពីបណ្ដាញសង្គម',
    'intake.subtitle': 'បិទភ្ជាប់តំណ TikTok, Instagram, YouTube, Xiaohongshu ឬតំណដំណើរកម្សាន្ត។',
    'intake.placeholder': 'បិទភ្ជាប់តំណ',
    'intake.action': 'នាំចូល',
    'intake.working': 'កំពុងពិនិត្យ…',
    'intake.received': 'យើងបានទទួលតំណរបស់អ្នក',
    'intake.receivedHint': 'យើងបានរក្សាទុកវាដើម្បីដំណើរការ។ យើងមិនទាន់អានវាទេ — មិនទាន់មានអ្វីបញ្ចូលទៅដំណើរកម្សាន្តទេ។',
    'intake.already': 'អ្នកបានផ្ញើតំណនេះរួចហើយ។ គ្មានការស្ទួនទេ។',
    'intake.another': 'ផ្ញើមួយទៀត',
    'intake.signIn': 'ចូលគណនី',
    'intake.signInHint': 'ការរក្សាទុកតំណត្រូវការគណនី ដើម្បីមាននៅគ្រប់ឧបករណ៍។',
    'intake.error.invalid': 'នេះមិនមែនជាតំណទេ។ សូមពិនិត្យ ហើយព្យាយាមម្តងទៀត។',
    'intake.error.unsupported': 'យើងមិនអាចទទួលតំណនោះបានទេ។',
    'intake.error.rateLimited': 'តំណច្រើនពេកក្នុងពេលតែមួយ។ សូមរង់ចាំបន្តិច។',
    'intake.error.unavailable': 'ការនាំចូលមិនអាចប្រើបានឥឡូវទេ។ សូមព្យាយាមឆាប់ៗ។',
    'intake.error.server': 'មានបញ្ហាខាងយើង។ សូមព្យាយាមម្តងទៀត។',
    'intake.processing': 'កំពុងអានតំណរបស់អ្នក…',
    'intake.processingHint': 'ទីតាំង និងផែនការអាចត្រូវបានអានខុស ឬអានមិនបាន។',
    'intake.pollTimeout': 'វាចំណាយពេលយូរជាងធម្មតា។ វានៅតែដំណើរការ — សូមពិនិត្យម្តងទៀតបន្តិចទៀត។',
