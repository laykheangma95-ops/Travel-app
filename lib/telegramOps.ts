...
//   delivery — the connect-token mint/hash and the deep link that carries a
//   traveller's eSIM QR. Nothing here touches that. These messages go to one
//   hard-coded staff chat id, never to a customer, and read no contact data
//   beyond what the ops message itself shows. Splitting them out means ops
//   alerting can change without reopening the locked delivery path.
// ─────────────────────────────────────────────────────────────────────────────
