    ...
    >
      ...
      {CHAPTERS.map((c) => (
        <div
          ...
          // The journey companion names whichever tagged section is on screen;
          // without this the chapters would leave it showing an empty pill.
          data-journey-section
          data-journey-label={km ? c.eyebrowKm : c.eyebrow}
