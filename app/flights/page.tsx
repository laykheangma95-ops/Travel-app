...
export default function FlightTrackerPage() {
  ...
  return (
    <div className="min-h-[80vh] bg-primary">
      <div className="mx-auto max-w-3xl px-4 py-20 sm:px-6">
        ...
        >
          <input
            ...
            className="flex-1 rounded-btn border border-white/20 bg-white/10 px-4 py-3.5 font-mono text-sm uppercase text-white placeholder:text-white/40 focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/30"
          />
          <input
            type="date"
            value={date}
            ...
            className="rounded-btn border border-white/20 bg-white/10 px-4 py-3.5 text-sm text-white focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/30 [color-scheme:dark]"
          />
          <button
            type="submit"
            className="inline-flex items-center justify-center gap-2 rounded-btn bg-accent px-6 py-3.5 text-sm font-semibold text-white shadow-lg shadow-accent/25 transition-all duration-200 ease-smooth hover:bg-orange-600 active:scale-[0.98]"
          >
