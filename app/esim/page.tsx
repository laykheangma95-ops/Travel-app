      ...
      >
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-btn border border-line bg-surface-1 py-3 pl-11 pr-4 text-sm transition-all focus:border-secondary focus:outline-none focus:ring-2 focus:ring-secondary/20"
          />
        </div>
        <button
          type="submit"
          ...
          <button
            ...
            className={cn(
              ...
              filter === f
                ...
                : 'bg-surface-1 text-ink-secondary border border-line hover:border-secondary hover:text-secondary'
            )}
          >
            {f}
          </button>
